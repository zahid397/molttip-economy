...
export const Trade: React.FC = () => {
  ...
  const validate = (): string => {
    ...
    if (numAmount > available)                          return `Insufficient. Available: ${formatNumber(available)} MOTIP`;
    return '';
  };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3">
          <form onSubmit={handleTrade} className="card space-y-5">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="font-display font-bold text-lg text-primary">Execute Trade</h2>
            </div>

            <div>
              <label className="text-xs font-mono text-text-secondary uppercase tracking-wider block mb-2">
                From Agent
              </label>
              <div className="relative">
                <select
                  value={fromId}
                  onChange={e => { setFromId(e.target.value); setToId(''); setError(''); setLastTxId(null); }}
                  required
            ...
            {fromAgent && toAgent && (
              <div className="flex items-center justify-between px-4 py-3
                rounded-lg bg-bg-elevated border border-default text-xs font-mono">
            ...
            >
              {isPending
                ...
                : <><Zap size={15} fill="currentColor" />
                    Execute Trade{numAmount > 0 ? ` · ${formatNumber(numAmount)} MOTIP` : ''}
                  </>
              }
            </button>
          </form>
        ...
        <div className="lg:col-span-2 space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="font-display font-bold text-lg text-primary">Recent Trades</h2>
          </div>
