    ...
    <div className="space-y-6 page-enter">
      ...
      {top3.length >= 3 && (
        <div className="grid grid-cols-3 gap-3">
          {([top3[1], top3[0], top3[2]] as LeaderboardEntry[]).map(entry => {
            ...
            return (
              <div
                key={entry.agentId}
                className={cn(
                  'card text-center relative overflow-hidden border transition-all',
                  cfg.bg,
      ...
      <div className="card p-0 overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3
          ...
          <span className="font-mono text-2xs text-text-muted">{sorted.length} agents</span>
        </div>
                    ...
                    <tr key={entry.agentId}>
                      ...
                      <td>
                        <div className="flex items-center gap-1.5">
                          ...
                          <span className="font-mono text-text-primary">{entry.tradeCount}</span>
                        </div>
                      </td>
                      <td>
                        <div className="flex items-center gap-2">
